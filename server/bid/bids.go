...
func AddMockBids() {
	...
	bids = append(bids, Bid{UserID: "u1", ItemID: "i1", Amount: "4890"})
	bids = append(bids, Bid{UserID: "u1", ItemID: "i2", Amount: "2335"})
	bids = append(bids, Bid{UserID: "u2", ItemID: "i2", Amount: "5324"})
	bids = append(bids, Bid{UserID: "u2", ItemID: "i1", Amount: "7122"})
